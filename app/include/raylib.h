...
*       [rtextures] stb_image (Sean Barret) for sprites loading (BMP, TGA, PNG, JPEG, HDR...)
...
RLAPI void SetWindowIcons(Image *images, int count);              // Set icon for window (multiple sprites, RGBA 32bit)
